...
class ScreenAuthMatrix {
  ...
  static getMatrixDefinition() {
    return [
      ...
      // ═══════════════════════════════════════════════════════════════
      { id: 'drawers_modals_division', label: 'Global: Drawers & Modals Division', type: 'SCREEN', selector: '.drawer, .modal, .modal-backdrop, .drawer-overlay', category: 'Global: Drawers & Modals', level: 0, roles: { MASTER: true, HEALER: true, TRAINEE: true, DEVOTEE: true, SEEKER: true }, portals: { masters: true, healers: true, trainee: true, devotee: true, seeker: true } },
